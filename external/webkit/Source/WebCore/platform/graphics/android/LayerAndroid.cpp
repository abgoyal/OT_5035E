...
LayerAndroid::LayerAndroid(SkPicture* picture) : Layer(),
    ...
    //In order to using highlight function in Email, we should make m_uniqueId -1, just as the design of android 2.3, hardware-acceleration disabled.
    m_uniqueId(-1),//(++gUniqueId),
    m_texture(0),
    m_imageCRC(0),
    m_scale(1),
    m_lastComputeTextureSize(0),
