...
#define INIT_ERROR_LOGFUNC(_Fmt...)
#define INIT_WARN_LOGFUNC(_Fmt...)
#define INIT_INFO_LOGFUNC(_Fmt...)
#define INIT_STATE_LOGFUNC(_Fmt...)
#define INIT_EVENT_LOGFUNC(_Fmt...)
#define INIT_TRACE_LOGFUNC(_Fmt...)
#define INIT_LOUD_LOGFUNC(_Fmt...)
#define INIT_TEMP_LOGFUNC(_Fmt...)

#define AAA_ERROR_LOGFUNC(_Fmt...)
#define AAA_WARN_LOGFUNC(_Fmt...)
#define AAA_INFO_LOGFUNC(_Fmt...)
#define AAA_STATE_LOGFUNC(_Fmt...)
#define AAA_EVENT_LOGFUNC(_Fmt...)
#define AAA_TRACE_LOGFUNC(_Fmt...)
#define AAA_LOUD_LOGFUNC(_Fmt...)
#define AAA_TEMP_LOGFUNC(_Fmt...)
...
#define CNM_ERROR_LOGFUNC(_Fmt...)
#define CNM_WARN_LOGFUNC(_Fmt...)
#define CNM_INFO_LOGFUNC(_Fmt...)
#define CNM_STATE_LOGFUNC(_Fmt...)
#define CNM_EVENT_LOGFUNC(_Fmt...)
#define CNM_TRACE_LOGFUNC(_Fmt...)
#define CNM_LOUD_LOGFUNC(_Fmt...)
...
#define QM_ERROR_LOGFUNC(_Fmt...)
#define QM_WARN_LOGFUNC(_Fmt...)
#define QM_INFO_LOGFUNC(_Fmt...)
#define QM_STATE_LOGFUNC(_Fmt...)
#define QM_EVENT_LOGFUNC(_Fmt...)
#define QM_TRACE_LOGFUNC(_Fmt...)
#define QM_LOUD_LOGFUNC(_Fmt...)
#define QM_TEMP_LOGFUNC(_Fmt...)
