...
typedef enum
{
	...
	Cust_CC_1000MA = 0x6,
	Cust_CC_900MA  = 0x7,
	Cust_CC_850MA  = 0x8,			//mingquan.lai modify for Camry	PIO
	Cust_CC_700MA  = 0x9,
	Cust_CC_650MA  = 0xA,
	Cust_CC_550MA  = 0xB,
	Cust_CC_442MA  = 0xC,			//mingquan.lai modify for Camry	PIO
	Cust_CC_400MA  = 0xD,
	Cust_CC_200MA  = 0xE,
	Cust_CC_70MA   = 0xF,
	Cust_CC_0MA	   = 0xDD
...
#define USB_CHARGER_CURRENT_CONFIGURED		Cust_CC_442MA	// def CONFIG_USB_IF  mingquan.lai modify for Camry PIO
#define USB_CHARGER_CURRENT					Cust_CC_442MA	//mingquan.lai modify for Camry	PIO
#define AC_CHARGER_CURRENT					Cust_CC_850MA	//mingquan.lai modify for Camry	PIO
