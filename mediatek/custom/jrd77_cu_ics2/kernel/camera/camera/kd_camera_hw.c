...
//printk("zrl6 add SensorIdx=%d,currSensorName=%s,On=%d,mode_name=%s.\n",SensorIdx,*currSensorName,On,*mode_name);
...
if (0 == strcmp("ov5647mipiraw",currSensorName)) {
		pinSet = ov5647;
		printk("XXXXXXXXXXXXXXXXXXXXXXXXXXXXX pinSet == ov5647 XXXXXXXXXXXXXXXXXX");
}
/*
else {
		pinSet = ov8825;
		printk("XXXXXXXXXXXXXXXXXXXXXXXXXXXXX pinSet == ov8825 XXXXXXXXXXXXXXXXXX");
}
*/
