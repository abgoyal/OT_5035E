...
static int s4FM50AF_ReadReg(unsigned short * a_pu2Result)
{
  ...
  //  *a_pu2Result = (((u16)pBuff[0]) << 4) + (pBuff[1] >> 4);
    *a_pu2Result = (((u16)(pBuff[0] & 0x03)) << 8) + pBuff[1];  //by truly 2012.9.11
    return 0;
}
/*
...
static int s4FM50AF_WriteReg(u16 a_u2Data)
{
	...
	FM50AFDB("zrl add in s4FM50AF_WriteReg. \n");

    // change to BU6424 by truly 2012.06.04
//    char puSendCmd[2] = {(char)(a_u2Data >> 4) , (char)(((a_u2Data & 0xF) << 4)+0xF)};
    char puSendCmd[2] = {(char)(((a_u2Data >> 8) & 0x03) | 0xc0), (char)(a_u2Data & 0xff)}; //by truly 2012.9.11
