...
AUDIO_CUSTOM_PARAM_STRUCT speech_custom_default1 =
{
    /* INT8 volume[MAX_VOL_CATE][MAX_VOL_TYPE] */
    /* Normal volume: TON, SPK, MIC, FMR, SPH, SID, MED */
    GAIN_NOR_TON_VOL1, GAIN_NOR_KEY_VOL1, GAIN_NOR_MIC_VOL1, GAIN_NOR_FMR_VOL1, GAIN_NOR_SPH_VOL1, GAIN_NOR_SID_VOL1, GAIN_NOR_MED_VOL1
    ,
    /* Headset volume: TON, SPK, MIC, FMR, SPH, SID, MED */
    GAIN_HED_TON_VOL1, GAIN_HED_KEY_VOL1, GAIN_HED_MIC_VOL1, GAIN_HED_FMR_VOL1, GAIN_HED_SPH_VOL1, GAIN_HED_SID_VOL1, GAIN_HED_MED_VOL1
    ,
    /* Handfree volume: TON, SPK, MIC, FMR, SPH, SID, MED */
    GAIN_HND_TON_VOL1, GAIN_HND_KEY_VOL1, GAIN_HND_MIC_VOL1, GAIN_HND_FMR_VOL1, GAIN_HND_SPH_VOL1, GAIN_HND_SID_VOL1, GAIN_HND_MED_VOL1
    ,
    /* UINT16 speech_common_para[12] */
    DEFAULT_SPEECH_COMMON_PARA1
    ,
    /* UINT16 speech_mode_para[8][16] */
    DEFAULT_SPEECH_NORMAL_MODE_PARA1,
    DEFAULT_SPEECH_EARPHONE_MODE_PARA1,
    DEFAULT_SPEECH_LOUDSPK_MODE_PARA1,
    DEFAULT_SPEECH_BT_EARPHONE_MODE_PARA1,
    DEFAULT_SPEECH_BT_CORDLESS_MODE_PARA1,
    DEFAULT_SPEECH_CARKIT_MODE_PARA1,
    DEFAULT_SPEECH_AUX1_MODE_PARA1,
    DEFAULT_SPEECH_AUX2_MODE_PARA1
    ,
    /* UINT16 speech_volume_para[4] */
    DEFAULT_SPEECH_VOL_PARA1
    ,
    /* UINT16 debug_info[16] */
    DEFAULT_AUDIO_DEBUG_INFO1
    ,
    /* INT16 sph_in_fir[6][45], sph_out_fir */
    SPEECH_INPUT_FIR_COEFF1,
    SPEECH_OUTPUT_FIR_COEFF1
    ,
    /* UINT16 DG_DL_Speech */
    DG_DL_Speech1
    ,
    ...
    DEFAULT_BLUETOOTH_SYNC_TYPE1,
    DEFAULT_BLUETOOTH_SYNC_LENGTH1
    ,
    /* UINT16 BT PCM in/out digital gain*/
    DEFAULT_BT_PCM_IN_VOL1,
    DEFAULT_BT_PCM_OUT_VOL1
    ,
...
AUDIO_CUSTOM_WB_PARAM_STRUCT wb_speech_custom_default1 =
{
    /* unsigned short speech_mode_wb_para[8][16] */
    DEFAULT_WB_SPEECH_NORMAL_MODE_PARA1,
    DEFAULT_WB_SPEECH_EARPHONE_MODE_PARA1,
    DEFAULT_WB_SPEECH_LOUDSPK_MODE_PARA1,
    DEFAULT_WB_SPEECH_BT_EARPHONE_MODE_PARA1,
    DEFAULT_WB_SPEECH_BT_CORDLESS_MODE_PARA1,
    DEFAULT_WB_SPEECH_CARKIT_MODE_PARA1,
    DEFAULT_WB_SPEECH_AUX1_MODE_PARA1,
    DEFAULT_WB_SPEECH_AUX2_MODE_PARA1,
    /* short sph_wb_in_fir[6][90] */
    WB_Speech_Input_FIR_Coeff1,
    /* short sph_wb_out_fir[6][90] */
    WB_Speech_Output_FIR_Coeff1,
};
...
AUDIO_PARAM_MED_STRUCT audio_param_med_default1 =
{
    SPEECH_INPUT_MED_FIR_COEFF1,
    SPEECH_OUTPUT_MED_FIR_COEFF1,
    FIR_output_index1,
    FIR_input_index1,
    MED_SPEECH_NORMAL_MODE_PARA1,
    MED_SPEECH_EARPHONE_MODE_PARA1,
    MED_SPEECH_BT_EARPHONE_MODE_PARA1,
    MED_SPEECH_LOUDSPK_MODE_PARA1,
    MED_SPEECH_CARKIT_MODE_PARA1,
    MED_SPEECH_BT_CORDLESS_MODE_PARA1,
    MED_SPEECH_AUX1_MODE_PARA1,
    MED_SPEECH_AUX2_MODE_PARA1
};
...
AUDIO_VOLUME_CUSTOM_STRUCT audio_volume_custom_default1 =
{
    AUD_VOLUME_RING1,
    AUD_VOLUME_KEY1,
    AUD_VOLUME_MIC1,
