...
{	
    ...
    fan5405_config_interface_liao(0x06,0x77); // set ISAFE and HW CV point (4.34)  mingquan.lai modify for Camry PIO 850mA
#else
    printf("[fan5405_hw_init] (0x06,0x70)\n");
    fan5405_config_interface_liao(0x06,0x70); // set ISAFE  mingquan.lai modify for Camry PIO 850mA
#endif
}
