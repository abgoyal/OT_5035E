...
enum fan5405_charger_status{
	CHARGER_FAULT_NOW = 0x00,
	CHARGER_RECOVERY_FROM_FAULT = 0x01,
	CHARGER_TYPE_CHANGED	= 0x02,
	CHARGER_IN_PROGRESS_STATUS	= 0x03,
	CHARGER_FINISHED_STATUS	= 0x04,
	CHARGER_STOPED	= 0x05,
	CHARGER_READY_STATUS = 0x06,
	CHARGER_INVALID
};
...
enum charge_mode_fault_status{
        ...
        CHAREG_POOR_INPUT_SOURCE        = 0x03, /**/
        CHAREG_BATTERY_OVP      = 0x04, /**/
