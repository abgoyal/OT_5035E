...
#define MT6577_SYSRAM_BASE_PA 0xC2000000
#define MT6577_SYSRAM_BASE_VA 0xF2000000
#define MT6577_SYSRAM_SIZE    0x40000 //256kb
...
#if defined TV_BUFFER_PIPE
    _tvrContext.descAddr = desc_addr - MT6577_SYSRAM_BASE_PA + MT6577_SYSRAM_BASE_VA;
#endif
#else
...
{
 #if ENABLE_TVROT_INTERRUPT
    if (request_irq(MT6577_TV_ROT_IRQ_ID,
        (irq_handler_t)_TVR_InterruptHandler, IRQF_TRIGGER_LOW, "mt6577-tvrot", NULL) < 0)
    {
...
bool TVR_EnqueueBuffer(UINT32 addr, UINT32* pAddrPrev)
{
    ...
    */
    ...
    ASSERT(MT6577_SYSRAM_BASE_VA <= descAddr &&
                 descAddr < MT6577_SYSRAM_BASE_VA + MT6577_SYSRAM_SIZE);
