...
BATTERY_PROFILE_STRUC_P fgauge_get_profile(kal_uint32 temperature)
{
    ...
    {
        case TEMPERATURE_T0:
	     if(byd_fmt_batt_id==1)
            return &battery_profile_t0[0];
	     else
	     return &fmt_battery_profile_t0[0];
            break;    
        case TEMPERATURE_T1:
	     if(byd_fmt_batt_id==1)
            return &battery_profile_t1[0];
	     else
	     return &fmt_battery_profile_t1[0];
            break;
        case TEMPERATURE_T2:
	     if(byd_fmt_batt_id==1)
            return &battery_profile_t2[0];
	     else
	     return &fmt_battery_profile_t2[0];
            break;
        case TEMPERATURE_T3:
	     if(byd_fmt_batt_id==1)
            return &battery_profile_t3[0];
	     else
	     return &fmt_battery_profile_t3[0];
            break;
        case TEMPERATURE_T:
...
R_PROFILE_STRUC_P fgauge_get_profile_r_table(kal_uint32 temperature)
{
    switch (temperature)
    {
    	case TEMPERATURE_T0:
	     ...
	     return &fmt_r_profile_t0[0];
            break;
        case TEMPERATURE_T1:
	     if(byd_fmt_batt_id==1)
            return &r_profile_t1[0];
	     else
	     return &fmt_r_profile_t1[0];
            break;
        case TEMPERATURE_T2:
	     if(byd_fmt_batt_id==1)
            return &r_profile_t2[0];
	     else
	     return &fmt_r_profile_t2[0];
            break;
        case TEMPERATURE_T3:
	     if(byd_fmt_batt_id==1)
            return &r_profile_t3[0];
	     else
	     return &fmt_r_profile_t3[0];
            break;
        case TEMPERATURE_T:
...
kal_int32 fgauge_get_Q_max(kal_int16 temperature)
{
	...
	if (temperature <= TEMPERATURE_T1)
    {
		...
		{
		low_Q_max = FMT_Q_MAX_NEG_10;
		high_Q_max = FMT_Q_MAX_POS_0;
		}
		if(temperature < low_temperature)
		{
			temperature = low_temperature;
	...
	else if (temperature <= TEMPERATURE_T2)
    {
		...
		{
              low_Q_max = FMT_Q_MAX_POS_0;
		high_Q_max = FMT_Q_MAX_POS_25;
		}
		if(temperature < low_temperature)
		{
			temperature = low_temperature;
    ...
    else
    {
		...
		{
              low_Q_max = FMT_Q_MAX_POS_25;
		high_Q_max = FMT_Q_MAX_POS_50;
		}
		if(temperature > high_temperature)
		{
			temperature = high_temperature;
...
kal_int32 fgauge_get_Q_max_high_current(kal_int16 temperature)
{
	...
	if (temperature <= TEMPERATURE_T1)
    {
		...
		{
              low_Q_max = FMT_Q_MAX_NEG_10_H_CURRENT;
		high_Q_max = FMT_Q_MAX_POS_0_H_CURRENT;
		}
		if(temperature < low_temperature)
		{
			temperature = low_temperature;
	...
	else if (temperature <= TEMPERATURE_T2)
    {
		...
		{
		low_Q_max = FMT_Q_MAX_POS_0_H_CURRENT;
		high_Q_max = FMT_Q_MAX_POS_25_H_CURRENT;
		}
		if(temperature < low_temperature)
		{
			temperature = low_temperature;
    ...
    else
    {
		...
		{
              low_Q_max = FMT_Q_MAX_POS_25_H_CURRENT;
		high_Q_max = FMT_Q_MAX_POS_50_H_CURRENT;
		}
		if(temperature > high_temperature)
		{
			temperature = high_temperature;
...
{	
	...
	{
	gFG_BATT_CAPACITY_init_high_current = FMT_Q_MAX_POS_25_H_CURRENT;
	//gFG_BATT_CAPACITY_aging = gFG_BATT_CAPACITY_init_high_current;
	gFG_BATT_CAPACITY_aging = FMT_Q_MAX_POS_25;
       }
// 1. HW initialization
