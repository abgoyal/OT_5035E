...
#define MID_RGB_ROT0_EX     (1u << MID_RGB_ROT0_i | 1u << 31) //added by jrd-bzhu for porting P61_JRD308180_For_JRD77_CU_ICS2_ALPS.ICS2.6577.SP.V1_P61_.tar.gz
...
typedef struct {
//
    bool          bStopAfterZSDDone; //added by jrd-bzhu for porting P61_JRD308180_For_JRD77_CU_ICS2_ALPS.ICS2.6577.SP.V1_P61_.tar.gz
//CRZ
    unsigned long u4CRZLBMAX;//+0x0 CRZ_CFG
    unsigned long u4CRZSrcSZ;//+0x10 CRZ_SRCSZ
    unsigned long u4CRZTarSZ;//+0x14 CRZ_TARSZ
    ...
    unsigned long u4CRZCropTB;//+0xF8 CRZ_CropTB
//RGBROT0 descriptor
    //unsigned long u4RGB0Seg1;//dstAddr //deleted by jrd-bzhu for porting P61_JRD308180_For_JRD77_CU_ICS2_ALPS.ICS2.6577.SP.V1_P61_.tar.gz
    unsigned long u4RGB0Seg1[16];//dstAddr  added by jrd-bzhu for porting P61_JRD308180_For_JRD77_CU_ICS2_ALPS.ICS2.6577.SP.V1_P61_.tar.gz
...
//} stZSDLastPreviewReg; //deleted by jrd-bzhu for porting P61_JRD308180_For_JRD77_CU_ICS2_ALPS.ICS2.6577.SP.V1_P61_.tar.gz
} stZSDPreviewReg; //added by jrd-bzhu for porting P61_JRD308180_For_JRD77_CU_ICS2_ALPS.ICS2.6577.SP.V1_P61_.tar.gz
...
// last preview frame for zsd
//#define MT6577MDP_T_SETLASTPREVIEWFRAME _IOW(MT6577_MDPMAGICNO , 12 , stZSDLastPreviewReg) //deleted by jrd-bzhu for porting P61_JRD308180_For_JRD77_CU_ICS2_ALPS.ICS2.6577.SP.V1_P61_.tar.gz
#define MT6577MDP_T_SETZSDPREVIEWFRAME _IOW(MT6577_MDPMAGICNO , 12 , stZSDPreviewReg) //added by jrd-bzhu for porting P61_JRD308180_For_JRD77_CU_ICS2_ALPS.ICS2.6577.SP.V1_P61_.tar.gz
...
extern int b_mdp_show_zsdinfo; //added by jrd-bzhu for porting P61_JRD308180_For_JRD77_CU_ICS2_ALPS.ICS2.6577.SP.V1_P61_.tar.gz
...
#define MDPK_ZSDINFO(fmt, arg...)    if( b_mdp_show_zsdinfo )     { MDPK_PRINTF("[MDPK ZSD]: "fmt, ##arg); } //added by jrd-bzhu for porting P61_JRD308180_For_JRD77_CU_ICS2_ALPS.ICS2.6577.SP.V1_P61_.tar.gz
