...
#if defined(CONFIG_KEYBOARD_MHL)
/*=======================================================================*/
/* MHL Keyboard  add by Liuxuming                                                 */
/*=======================================================================*/
static struct platform_device kbd_mhl_dev = {
    .name = "mhl-keyboard",
    .id   = -1,
};
#endif
...
static struct i2c_board_info __initdata i2c_devs1[]={
	...
	{ I2C_BOARD_INFO("OV8825AF", 0x6c), },//add by Ge Nan
...
#if defined(CONFIG_KEYBOARD_MHL)
	retval = platform_device_register(&kbd_mhl_dev);
	if (retval != 0){
		return retval;
	}	
#endif
