...
int b_mdp_show_zsdinfo    = 0; //added by jrd-bzhu for porting P61_JRD308180_For_JRD77_CU_ICS2_ALPS.ICS2.6577.SP.V1_P61_.tar.gz
...
typedef struct {
    spinlock_t SpinLock;
    unsigned long u4Dirty;
/*deleted by jrd-bzhu for porting P61_JRD308180_For_JRD77_CU_ICS2_ALPS.ICS2.6577.SP.V1_P61_.tar.gz
    stZSDLastPreviewReg stReg;
} stZSDLastPreviewSetting;
deleted by jrd-bzhu for porting P61_JRD308180_For_JRD77_CU_ICS2_ALPS.ICS2.6577.SP.V1_P61_.tar.gz end*/
/*added by jrd-bzhu for porting P61_JRD308180_For_JRD77_CU_ICS2_ALPS.ICS2.6577.SP.V1_P61_.tar.gz start*/
    stZSDPreviewReg stReg;
} stZSDPreviewSetting;
/*added by jrd-bzhu for porting P61_JRD308180_For_JRD77_CU_ICS2_ALPS.ICS2.6577.SP.V1_P61_.tar.gz end*/

//static stZSDLastPreviewSetting g_stMT6577ZSDLastPreview = //deleted by jrd-bzhu for porting P61_JRD308180_For_JRD77_CU_ICS2_ALPS.ICS2.6577.SP.V1_P61_.tar.gz
static stZSDPreviewSetting g_stMT6577ZSDPreview = //added by jrd-bzhu for porting P61_JRD308180_For_JRD77_CU_ICS2_ALPS.ICS2.6577.SP.V1_P61_.tar.gz
                    {
                        //.SpinLock   = __SPIN_LOCK_UNLOCKED(g_stMT6577ZSDLastPreview.SpinLock), //deleted by jrd-bzhu for porting P61_JRD308180_For_JRD77_CU_ICS2_ALPS.ICS2.6577.SP.V1_P61_.tar.gz
                        .SpinLock   = __SPIN_LOCK_UNLOCKED(g_stMT6577ZSDPreview.SpinLock), //added by jrd-bzhu for porting P61_JRD308180_For_JRD77_CU_ICS2_ALPS.ICS2.6577.SP.V1_P61_.tar.gz
                        .u4Dirty    =   0,
                    };
...
//static inline int DescQueueRefill(void) //deleted by jrd-bzhu for porting P61_JRD308180_For_JRD77_CU_ICS2_ALPS.ICS2.6577.SP.V1_P61_.tar.gz
static inline int DescQueueRefill(unsigned long index) //added by jrd-bzhu for porting P61_JRD308180_For_JRD77_CU_ICS2_ALPS.ICS2.6577.SP.V1_P61_.tar.gz
{
    ...
    #define _CHECK_Q_BUSY_AND_RETURN_( _seg_name_ ) \
        if( _DescWriteWaitBusy( RGB_ROT0_BASE ) < 0 ){\
            ...
            return -1; }
    //stZSDLastPreviewReg * pstReg = &g_stMT6577ZSDLastPreview.stReg; //deleted by jrd-bzhu for porting P61_JRD308180_For_JRD77_CU_ICS2_ALPS.ICS2.6577.SP.V1_P61_.tar.gz
    stZSDPreviewReg * pstReg = &g_stMT6577ZSDPreview.stReg; //added by jrd-bzhu for porting P61_JRD308180_For_JRD77_CU_ICS2_ALPS.ICS2.6577.SP.V1_P61_.tar.gz
...
//static inline void UpdateZsdLastPreviewReg(bool log_en) //deleted by jrd-bzhu for porting P61_JRD308180_For_JRD77_CU_ICS2_ALPS.ICS2.6577.SP.V1_P61_.tar.gz
static inline unsigned long UpdateZsdPreviewReg(void) //added by jrd-bzhu for porting P61_JRD308180_For_JRD77_CU_ICS2_ALPS.ICS2.6577.SP.V1_P61_.tar.gz
{
    ...
    unsigned long ret = 0xff; //added by jrd-bzhu for porting P61_JRD308180_For_JRD77_CU_ICS2_ALPS.ICS2.6577.SP.V1_P61_.tar.gz
    ...
    if(reg_q_base_pa < MT6577_SYSRAM_PA)
    {
		...
		//return; //deleted by jrd-bzhu for porting P61_JRD308180_For_JRD77_CU_ICS2_ALPS.ICS2.6577.SP.V1_P61_.tar.gz
        return ret; //added by jrd-bzhu for porting P61_JRD308180_For_JRD77_CU_ICS2_ALPS.ICS2.6577.SP.V1_P61_.tar.gz
    }
	...
	/*deleted by jrd-bzhu for porting P61_JRD308180_For_JRD77_CU_ICS2_ALPS.ICS2.6577.SP.V1_P61_.tar.gz start
    if (log_en)
    {
    ...
    for(q_index = 0 ; q_index < reg_q_depth ; q_index += 1)
    {
        ...
        //descriptBase[0] = pstReg->u4RGB0Seg1; //deleted by jrd-bzhu for porting P61_JRD308180_For_JRD77_CU_ICS2_ALPS.ICS2.6577.SP.V1_P61_.tar.gz
		/*added by jrd-bzhu for porting P61_JRD308180_For_JRD77_CU_ICS2_ALPS.ICS2.6577.SP.V1_P61_.tar.gz start*/
		...
		deleted by jrd-bzhu for porting P61_JRD308180_For_JRD77_CU_ICS2_ALPS.ICS2.6577.SP.V1_P61_.tar.gz end*/
        MDPK_ZSDINFO("[ZSD] Descriptor(0x%08x) New -> 0x%08x 0x%08x 0x%08x 0x%08x 0x%08x 0x%08x 0x%08x\n", //added by jrd-bzhu for porting P61_JRD308180_For_JRD77_CU_ICS2_ALPS.ICS2.6577.SP.V1_P61_.tar.gz
    ...
    {
	/*adde by jrd-bzhu for porting P61_JRD308180_For_JRD77_CU_ICS2_ALPS.ICS2.6577.SP.V1_P61_.tar.gz end*/
...
//static int MT6577_SetZSDLastPreview(stZSDLastPreviewReg * a_u4Param) //deleted by jrd-bzhu for porting P61_JRD308180_For_JRD77_CU_ICS2_ALPS.ICS2.6577.SP.V1_P61_.tar.gz
static int MT6577_SetZSDPreview(stZSDPreviewReg * a_u4Param) //added by jrd-bzhu for porting P61_JRD308180_For_JRD77_CU_ICS2_ALPS.ICS2.6577.SP.V1_P61_.tar.gz
{
    unsigned long   flag;

	/*deleted by jrd-bzhu for porting P61_JRD308180_For_JRD77_CU_ICS2_ALPS.ICS2.6577.SP.V1_P61_.tar.gz start
    spin_lock_irqsave(&g_stMT6577ZSDLastPreview.SpinLock , flag);
    g_stMT6577ZSDLastPreview.u4Dirty= 0;
    spin_unlock_irqrestore(&g_stMT6577ZSDLastPreview.SpinLock , flag);

    if(copy_from_user(&g_stMT6577ZSDLastPreview.stReg , (struct stZSDLastPreviewReg *)a_u4Param , sizeof(stZSDLastPreviewReg)))
	deleted by jrd-bzhu for porting P61_JRD308180_For_JRD77_CU_ICS2_ALPS.ICS2.6577.SP.V1_P61_.tar.gz end */
	/*added by jrd-bzhu for porting P61_JRD308180_For_JRD77_CU_ICS2_ALPS.ICS2.6577.SP.V1_P61_.tar.gz start*/
    ...
    */
    ...
    else
    {
		/*deleted by jrd-bzhu for porting P61_JRD308180_For_JRD77_CU_ICS2_ALPS.ICS2.6577.SP.V1_P61_.tar.gz start
        spin_lock_irqsave(&g_stMT6577ZSDLastPreview.SpinLock , flag);
        g_stMT6577ZSDLastPreview.u4Dirty = 1;
        spin_unlock_irqrestore(&g_stMT6577ZSDLastPreview.SpinLock , flag);
		deleted by jrd-bzhu for porting P61_JRD308180_For_JRD77_CU_ICS2_ALPS.ICS2.6577.SP.V1_P61_.tar.gz end */
		/*added by jrd-bzhu for porting P61_JRD308180_For_JRD77_CU_ICS2_ALPS.ICS2.6577.SP.V1_P61_.tar.gz start*/
        spin_lock_irqsave(&g_stMT6577ZSDPreview.SpinLock , flag);
...
{
    if(g_stMT6577ZSDLastPreview.u4Dirty)
    {
...
//Debug - E
            ...
            //UpdateZsdLastPreviewFrame(); //deleted by jrd-bzhu for porting P61_JRD308180_For_JRD77_CU_ICS2_ALPS.ICS2.6577.SP.V1_P61_.tar.gz
            UpdateZsdPreviewFrame(); //added by jrd-bzhu for porting P61_JRD308180_For_JRD77_CU_ICS2_ALPS.ICS2.6577.SP.V1_P61_.tar.gz
        }
...
// last preview frame for zsd
		/*deleted by jrd-bzhu for porting P61_JRD308180_For_JRD77_CU_ICS2_ALPS.ICS2.6577.SP.V1_P61_.tar.gz start
        case MT6577MDP_T_SETLASTPREVIEWFRAME:
            i4RetVal = MT6577_SetZSDLastPreview((stZSDLastPreviewReg *)a_u4Param);
		deleted by jrd-bzhu for porting P61_JRD308180_For_JRD77_CU_ICS2_ALPS.ICS2.6577.SP.V1_P61_.tar.gz end */
		/*added by jrd-bzhu for porting P61_JRD308180_For_JRD77_CU_ICS2_ALPS.ICS2.6577.SP.V1_P61_.tar.gz start*/
                            ...
                            int count,  int *eof, void *data )
{
    ...
    MDPFLAG_DUMPOUT( 0, page + len, b_mdp_show_zsdinfo , len ); //added by jrd-bzhu for porting P61_JRD308180_For_JRD77_CU_ICS2_ALPS.ICS2.6577.SP.V1_P61_.tar.gz
                   ...
                   unsigned long count, void *data)
{
    ...
    if (sscanf(cmd_buf, "%s %x",  variable_name, (unsigned int *)&value) == 2) {
        ...
        MDPFLAG_VARSET( variable_name, b_mdp_show_zsdinfo, value, b_set); //added by jrd-bzhu for porting P61_JRD308180_For_JRD77_CU_ICS2_ALPS.ICS2.6577.SP.V1_P61_.tar.gz
    ...
    else
    {
        ...
        MDPFLAG_DUMPOUT( 1, NULL, b_mdp_show_zsdinfo , dummy ); //added by jrd-bzhu for porting P61_JRD308180_For_JRD77_CU_ICS2_ALPS.ICS2.6577.SP.V1_P61_.tar.gz
