...
//Chu Hongyu adds about version on 2012 03 14
#include <version.inc>
//#include<version_jrd_uboot.h>
...
// Chu Hongyu adds version start on 2012 03 14	
	strlen += sprintf(commandline, "%s%s%s%s%s",
            commandline," jrd_pl_ver=", (char *)(&PRELOADER_VER),
            " jrd_uboot_ver=",UBOOT_VER);
           
// Chu Hongyu adds version end on 2012 03 14	
...
// Chu Hongyu adds version end on 2012 03sssss
